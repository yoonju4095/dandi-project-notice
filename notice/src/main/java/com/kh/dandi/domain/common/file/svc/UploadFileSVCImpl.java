package com.kh.dandi.domain.common.file.svc;

import com.kh.dandi.domain.common.file.dao.UploadFileDAO;
import com.kh.dandi.domain.entity.UploadFile;
import com.kh.dandi.web.common.AttachFileType;
import com.kh.dandi.web.exception.BizException;
...
//    uploadFile.setRid(rid);
  ...
  public List<UploadFile> convert(List<MultipartFile> mfs, AttachFileType attachFileType) {
    if(mfs == null || mfs.isEmpty()) {
      return Collections.emptyList(); // 혹은 null을 반환할 수도 있습니다.
    }
